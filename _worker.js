...
async function 获取前端页面(pathWithQuery, status = 200) {
	try {
		...
		html = html.replace(/<title>管理后台<\/title>/i, '<title>Admin Dashboard<\/title>');
		...
		const dict = {"管理后台": "Admin Dashboard", "登录设置页面": "Login", "配置错误": "Configuration Error", "请输入管理密码": "Enter Admin Password", "保存并登录": "Login", "正在验证密码...": "Verifying password...", "密码错误": "Incorrect password", "管理密码": "Admin Password", "管理员密码": "Admin Password", "未配置 ADMIN 环境变量": "ADMIN environment variable not set", "未设置 管理员密码": "ADMIN Password Not Set", "未绑定 KV 命名空间": "KV namespace not bound", "未绑定 KV命名空间": "KV namespace not bound", "请在 Cloudflare 控制台添加": "Please configure in Cloudflare console", "请绑定 KV 数据库": "Please bind KV database", "重定向中...": "Redirecting...", "强力驱动": "Powered by", "当前版本": "Current Version", "源码": "Source", "基本配置": "Basic Config", "节点配置": "Node Config", "节点管理": "Node Management", "访问日志": "Access Logs", "订阅管理": "Subscriptions", "反代设置": "Reverse Proxy", "反代配置": "Reverse Proxy", "系统设置": "System Settings", "流量统计": "Traffic Statistics", "高级设置": "Advanced Settings", "高级参数": "Advanced Settings", "协议与安全": "Protocols & Security", "自定义优选": "Custom Optimized", "自定义优选IP": "Custom Optimized IPs", "自定义优选地址": "Custom Optimized Addresses", "节点测速": "Node Speed Test", "延迟测试": "Latency Test", "Cloudflare 统计": "Cloudflare Statistics", "Cloudflare 配置": "Cloudflare Config", "Telegram 通知": "Telegram Notifications", "Telegram Bot 通知": "Telegram Bot Notifications", "订阅转换配置": "Subconverter Config", "优选订阅生成": "Optimized Subscriptions", "网络信息": "Network Info", "在线优选": "Online Optimized", "链式代理": "Chained Proxy", "代理验证": "Proxy Verification", "二维码": "QR Code", "节点二维码": "Node QR Code", "查看二维码": "View QR Code", "使用说明": "Instructions", "更新日志": "Changelog", "关于": "About", "保存配置": "Save Config", "重置配置": "Reset Config", "退出登录": "Logout", "生成订阅": "Generate Subscription", "复制订阅": "Copy Subscription", "复制全部": "Copy All", "测试延迟": "Test Latency", "刷新日志": "Refresh Logs", "清空日志": "Clear Logs", "下载配置": "Download Config", "导入配置": "Import Config", "验证代理": "Verify Proxy", "验证优选API": "Verify Preferred API", "重命名": "Rename", "全选": "Select All", "反选": "Invert Selection", "删除": "Delete", "编辑": "Edit", "添加": "Add", "确认": "Confirm", "确定": "OK", "取消": "Cancel", "关闭": "Close", "复制": "Copy", "保存": "Save", "重置": "Reset", "刷新": "Refresh", "搜索": "Search", "检查": "Check", "清空": "Clear", "清除": "Clear", "获取更多": "Get More", "返回顶部": "Back to Top", "重新测试": "Retest", "开始测速": "Start Speed Test", "停止测速": "Stop Speed Test", "切换日间模式": "Switch to Light Mode", "切换夜间模式": "Switch to Dark Mode", "浅色模式": "Light Mode", "深色模式": "Dark Mode", "夜间模式": "Night Mode", "主题切换": "Toggle Theme", "配置已保存": "Configuration saved", "配置已重置": "Configuration reset", "配置已重置为默认值": "Configuration reset to default", "保存成功": "Saved successfully", "复制成功": "Copied successfully", "重置成功": "Reset successfully", "操作成功": "Operation successful", "操作失败": "Operation failed", "验证成功": "Verification successful", "验证失败": "Verification Failed", "代理有效": "Proxy is valid", "代理无效": "Proxy Invalid", "验证超时": "Verification Timed Out", "缺少代理参数": "Missing proxy parameter", "请输入代理地址": "Please enter proxy address", "代理地址格式无效": "Invalid proxy address format", "请输入链式代理地址": "Please enter chained proxy address", "链式代理地址格式无效": "Invalid chained proxy address format", "链式代理内容已变化，请重新验证": "Chained proxy changed, please re-verify", "链式代理节点已追加到自定义优选地址": "Chained proxy node appended to custom IPs", "当前后端版本暂不支持链式代理": "Current backend version does not support chained proxy", "无法连接到代理服务器": "Unable to connect to proxy server", "不支持的POST请求路径": "Unsupported POST request path", "配置不完整": "Incomplete configuration", "保存配置失败": "Failed to save config", "配置重置失败": "Failed to reset config", "查询请求量失败": "Failed to query request usage", "验证优选API失败": "Failed to verify preferred API", "自定义IP已保存": "Custom IPs saved", "保存自定义IP失败": "Failed to save custom IPs", "暂无数据": "No data available", "加载中...": "Loading...", "正在保存...": "Saving...", "正在重置...": "Resetting...", "正在测速...": "Testing latency...", "正在加载...": "Loading...", "成功": "Success", "失败": "Failure", "警告": "Warning", "提示": "Tip", "错误": "Error", "状态": "Status", "操作": "Action", "类型": "Type", "位置": "Location", "时间": "Time", "域名": "Domain", "路径": "Path", "端口": "Port", "协议": "Protocol", "密码": "Password", "密钥": "Key", "节点列表": "Node List", "节点名称": "Node Name", "节点地址": "Node Address", "优选节点": "Optimized Nodes", "优选订阅": "Optimized Subscriptions", "优选IP": "Optimized IP", "优选IPv4": "Optimized IPv4", "优选IPv6": "Optimized IPv6", "优选域名": "Optimized Domain", "反代IP": "Reverse Proxy IP", "反代模式": "Reverse Proxy Mode", "反代": "Reverse Proxy", "代理": "Proxy", "启用全局代理": "Enable Global Proxy", "路径模板": "Path Template", "请求用量": "Request Usage", "启用": "Enable", "禁用": "Disable", "开启": "Enable", "默认": "Default", "自定义": "Custom", "全局": "Global", "标准": "Standard", "白名单": "Whitelist", "黑名单": "Blacklist", "账号": "Account", "中国移动": "China Mobile", "中国联通": "China Unicom", "中国电信": "China Telecom", "移动优选": "Mobile Optimized", "联通优选": "Unicom Optimized", "电信优选": "Telecom Optimized", "官方优选": "Official Optimized", "CF官方优选": "CF Official", "CF移动优选": "CF Mobile", "CF联通优选": "CF Unicom", "CF电信优选": "CF Telecom", "地区": "Region", "国家": "Country", "城市": "City", "运营商": "ISP", "延迟": "Latency", "丢包率": "Packet Loss", "下载速度": "Download Speed", "国内": "Domestic", "国际": "International", "墙外测试": "Global Test", "国内测试": "Domestic Test", "未知": "Unknown", "腾讯微信": "WeChat (Tencent)", "阿里淘宝": "Taobao (Alibaba)", "百度": "Baidu", "哔哩哔哩": "Bilibili", "谷歌": "Google", "油管": "YouTube", "奈飞": "Netflix", "微软": "Microsoft", "推特": "Twitter / X", "脸书": "Facebook", "传输协议": "Transport Protocol", "跳过证书验证": "Skip Certificate Verification", "跳过TLS证书验证": "Skip TLS Certificate Verification", "启用0RTT": "Enable 0-RTT", "启用 0-RTT 快速连接": "Enable 0-RTT Fast Connection", "TLS分片": "TLS Fragmentation", "分片大小": "Fragment Size", "分片间隔": "Fragment Interval", "随机路径": "Random Path", "随机路径设置": "Random Path Settings", "固定路径": "Fixed Path", "动态路径": "Dynamic Path", "伪装域名(SNI)": "SNI Disguise Domain", "伪装域名": "SNI Domain", "应用层协议协商(ALPN)": "ALPN Protocols", "传输安全(TLS)": "Transport Security (TLS)", "启用ECH加密": "Enable ECH Encryption", "ECH 域名": "ECH Domain", "ECH DNS服务器": "ECH DNS Server", "Shadowsocks 加密算法": "Shadowsocks Cipher", "Shadowsocks 密码": "Shadowsocks Password", "Shadowsocks 端口": "Shadowsocks Port", "浏览器指纹": "Browser Fingerprint", "随机指纹": "Random Fingerprint", "谷歌浏览器": "Chrome", "火狐浏览器": "Firefox", "苹果浏览器": "Safari", "微软浏览器": "Edge", "本地IP库": "Local IP Pool", "随机IP": "Random IP", "随机数量": "Random Quantity", "指定端口": "Specified Port", "订阅名称": "Subscription Name", "订阅更新时间": "Subscription Update Interval", "仅输出节点信息": "Output Node Info Only", "启用 UDP": "Enable UDP", "启用 XUDP": "Enable XUDP", "启用 TLS 1.3": "Enable TLS 1.3", "插入节点类型": "Append Node Type", "基础节点排序": "Basic Node Sorting", "客户端自动协商": "Client Auto Negotiation", "阿里 DoH": "Alibaba DoH", "腾讯国密 DoH": "Tencent SM2 DoH", "OneDNS DoH": "OneDNS DoH", "360 DoH": "360 DoH", "小白推荐选这个！！！": "Recommended for beginners!", "推荐选这个": "Recommended", "可用性验证": "Availability Check", "重置配置将会初始化所有设置，包括订阅生成、节点信息、反代配置等。此操作不可撤销，请谨慎操作。": "Resetting configuration will initialize all settings, including subscription generation, node info, and reverse proxy settings. This action cannot be undone.", "清除 Cloudflare 配置后，将无法继续统计 Workers/Pages 的请求数。此操作不可撤销，请谨慎操作。": "Clearing Cloudflare config will disable request analytics for Workers/Pages. This action cannot be undone.", "清除 Telegram Bot 通知配置后，将无法继续接收 Telegram 消息通知。此操作不可撤销，请谨慎操作。": "Clearing Telegram Bot config will disable Telegram message notifications. This action cannot be undone.", "因为KV空间有限，所以只保留4MB的操作日志，当日志大小超过该容量会自动清理最老的日志记录。": "Due to limited KV storage, only 4MB of access logs are retained. Older logs will be cleaned automatically when exceeded.", "由优选 IP 指向的 Cloudflare 机房决定。比如优选到新加坡 CF，目标站看到的通常就是新加坡附近的 CF 出口。": "Determined by the Cloudflare data center pointed to by the optimized IP.", "由 PROXYIP/其他代理 决定。目标站看到的是跳板服务器在访问，不是优选 IP。": "Determined by PROXYIP or secondary proxy. The destination sees the proxy server IP, not the optimized IP.", "反代模式 使用 其他代理 且开启「全局代理」后，非Cloudflare站点也会走 其他代理，落地 IP 会跟着代理变化。": "When reverse proxy is enabled with Global Proxy on, non-Cloudflare traffic routes through the proxy, changing the outbound IP.", "用于客户端发起 gRPC 请求时的 User-Agent。": "User-Agent used by client for gRPC requests.", "Clash/Mihomo 内核使用默认 UA 时，可能被 Cloudflare 误判为 DDoS 异常流量并拦截。": "Default UA in Clash/Mihomo may be flagged by Cloudflare as DDoS traffic and blocked.", "若客户端为 Clash/Mihomo，请务必设置此项。": "If using Clash or Mihomo, be sure to configure this setting.", "启用ECH可以避免域名阻断-1现象！": "Enabling ECH avoids domain blocking (-1 error)!", "Shadowsocks 的加密方式，推荐使用 aes-128-gcm 以获得更好的性能和兼容性。": "Shadowsocks encryption method. aes-128-gcm is recommended for best performance.", "数据将以 HTTP 明文形态传输，不再具备 TLS加密 对链路的封装与伪装能力。": "Data will be transmitted in HTTP plaintext without TLS encryption encapsulation.", "关闭 TLS 后，数据将以 HTTP 明文形态传输，不再具备 TLS加密 对链路的封装与伪装能力。": "Disabling TLS transmits data in HTTP plaintext without TLS encryption encapsulation.", "但节点仍由 Shadowsocks AEAD（aes-128-gcm / aes-256-gcm）加密，流量数据本身依旧是加密传输。": "However, the node remains encrypted by Shadowsocks AEAD, so traffic payloads remain encrypted.", "节点信息": "Node Info", "订阅接口": "Subscription API", "订阅设置": "Subscription Settings", "反代类型": "Reverse Proxy Type", "代理协议": "Proxy Protocol", "代理地址": "Proxy Address", "代理端口": "Proxy Port", "代理密码": "Proxy Password", "代理账号": "Proxy Username", "连接状态": "Connection Status", "响应时间": "Response Time", "测速地址": "Speed Test URL", "测试结果": "Test Results", "请求日志": "Request Logs", "日志通知": "Log Notification", "日志内容": "Log Content", "日志条目": "Log Entries", "历史记录": "History", "清空确认": "Confirm Clear", "重置确认": "Confirm Reset", "保存确认": "Confirm Save", "请输入": "Please enter ", "选择": "Select", "请选择": "Please select ", "请选择代理": "Please select a proxy", "很抱歉，当前地区无可用代理，请切换其他地区。": "No available proxies found in this region. Please switch to another region.", "很抱歉，当前地区无可用代理": "No available proxies found in this region", "请选择其他地区": "Please select another region", "复制节点链接": "Copy Node Link", "复制订阅链接": "Copy Subscription Link", "Clash 订阅": "Clash Subscription", "Sing-box 订阅": "Sing-box Subscription", "Surge 订阅": "Surge Subscription", "Quantumult X 订阅": "Quantumult X Subscription", "Loon 订阅": "Loon Subscription", "通用订阅": "Universal Subscription", "聚合订阅": "Aggregated Subscription", "明文配置": "Plain Configuration", "导入客户端": "Import to Client", "一键导入": "One-Click Import", "已复制到剪贴板": "Copied to clipboard", "复制失败": "Failed to copy", "支持的客户端": "Supported Clients", "使用帮助": "Help & Documentation", "配置说明": "Configuration Guide", "常见问题": "FAQ", "项目主页": "Project Homepage", "问题反馈": "Report Issue", "检查更新": "Check for Updates", "发现新版本": "New Version Available", "已是最新版本": "Already up to date", "版本号": "Version", "编译时间": "Build Time", "IP格式:": "IP Format:", "CIDR格式:": "CIDR Format:", "IP区间:": "IP Range:", "ECH 配置提示": "ECH Configuration Notice", "默认使用节点HOST伪装域名 配合 国内 DNS 可能导致 ECH 解析失败。": "Default node HOST SNI disguise with domestic DNS may cause ECH resolution failure.", "解决方案（任选其一）：": "Solutions (choose one):", "① 将 ECH 解析域名改为 cloudflare-ech.com（推荐）": "1. Change ECH resolution domain to cloudflare-ech.com (Recommended)", "② 将 ECH DNS 切换为国际服务（如 NextDNS）": "2. Switch ECH DNS to global service (such as NextDNS)", "ALPN（Application-Layer Protocol Negotiation）应用层协议协商。": "ALPN (Application-Layer Protocol Negotiation).", "默认「客户端自动协商」由客户端自行决定协议，兼容性最佳。": "Default 'Client Auto Negotiation' lets client choose protocol for best compatibility.", "手动指定后节点将固定使用所选协议集，若与客户端或网络环境不兼容，最坏情况会导致节点无法连接。": "Specifying manually locks node to chosen protocols; incompatibility may cause connection failure.", "支持版本": "Supported versions", "国内DNS需搭配设置ECH解析域名，是否可用需自行验证": "Domestic DNS requires ECH domain setting; please verify availability", "（Cloudflare ECH域名）小白推荐选这个！！！": "(Cloudflare ECH Domain) Recommended for beginners!", "用于解析 EchConfig 的域名，并非ECH伪装域名！CF ECH伪装域名均为 cloudflare-ech.com ！！！": "Domain for resolving EchConfig, NOT ECH disguise SNI! CF ECH disguise domain is always cloudflare-ech.com!", "启用（开启TLS，速度不会比VLESS/Trojan更快，因为Shadowsocks自带AEAD加密）": "Enabled (TLS on; not faster than VLESS/Trojan due to AEAD encryption overhead)", "API令牌权限 开启": "API Token Permissions: Enable", "权限即可": "permission only", "如果您不确定该选项的含义与影响，建议保持默认的「客户端自动协商」，由客户端自行完成协议协商。": "If unsure, keep default 'Client Auto Negotiation' to let client negotiate automatically.", "赋值，TOKEN 将进入“固定模式”，不再随 ADMIN/KEY 的变化而自动更新。": "Set fixed mode: TOKEN will no longer change automatically with ADMIN/KEY.", "指纹下生效。请选择处理方式：切换到支持的浏览器指纹以保留 ECH，或关闭 ECH。": "Active under fingerprint. Switch to supported fingerprint or disable ECH.", "如果你希望了解更完整、偏技术细节的说明，可以参考 Cloudflare 官方博客：": "For comprehensive technical details, please refer to the official Cloudflare blog:", "GFW 虽然不知道你在访问什么，但知道你在\"扶墙\"，并且知道你连接的是哪个域名。": "Censorship systems can detect proxy tunneling and see which domain you connect to.", "例如：油管、谷歌。Worker 可以直接访问，不需要先找 PROXYIP。": "e.g., YouTube, Google: Worker connects directly without routing through PROXYIP.", "，Worker 不能直接访问 Cloudflare 自己，所以需要跳板。": ", Worker cannot directly connect to Cloudflare edge, so a bounce proxy is needed.", "。系统将跳过动态生成，直接以此 UUID 生成对应的 订阅TOKEN。": ". System skips dynamic generation and generates subscription TOKEN directly from this UUID.", "用于显式指定节点所使用的应用层协议优先级，属于": "Used to explicitly specify node application-layer protocol priority, for", "请在高手模式下的\"⚙️ 详细配置信息\"，在\"HOST\"里添加您的域名": "In Expert Mode under 'Detailed Config', please add your domain in 'HOST'", "ECH（Encrypted Client Hello，加密客户端问候）": "ECH (Encrypted Client Hello)", "的 TLS 传输层加密。为了避免节点失联，请先确认部署环境满足要求。": "TLS transport encryption. To prevent disconnection, verify environment requirements first.", "的值，系统将动态生成 UUID 并自动同步生成新的 订阅TOKEN。": "value; system will dynamically generate UUID and auto-generate new subscription TOKEN.", "在性能不佳的老设备上，加解密速度会变慢": "Encryption/decryption may slow down on low-performance older devices", "用于节点验证的UUID 仅可通过 'UUID'环境变量 进行修改": "Node validation UUID can only be modified via 'UUID' environment variable", "Cloudflare Workers/Pages 可用请求数统计": "Cloudflare Workers/Pages Available Request Statistics", "版本 不支持跳过TLS证书验证功能": "version does not support skipping TLS certificate verification", "Cloudflare密码学服务": "Cloudflare Cryptography Service", "Prometheus 监控系统": "Prometheus Monitoring System", "Cloudflare加密SNI": "Cloudflare Encrypted SNI", "已追加": "Appended ", "条优选结果到自定义优选地址": " optimized results to custom addresses", "边缘证书": "Edge Certificates", "始终使用 HTTPS": "Always Use HTTPS", "自动识别URL中的端口号:": "Auto-detected port in URL: ", "并已移除port参数": "and removed port parameter", "后端版本过旧": "Backend Version Outdated", "您访问": "Your access to ", "所使用的IP": " IP address", "距离重置还有": "Time until reset: ", "小时": "hours", "分": " min ", "秒": " sec", "使用缓存更新日志，上次加载时间=": "Using cached changelog, loaded at: ", "综合滥用评分，基于运营商/ASN 历史记录和安全风险项计算。评分越低表示 IP 越纯净，越高表示被滥用可能性越大": "Abuse score based on ISP/ASN history and security risks. Lower is cleaner, higher indicates higher risk.", "该 IP 是否存在已知的滥用记录(如垃圾邮件、DDoS 攻击、恶意扫描等)。滥用 IP 通常会被安全系统拦截或限制访问": "Whether this IP has known abuse records (spam, DDoS, scanning).", "该 IP 是否来自移动网络运营商(如 4G/5G 网络)。移动网络 IP 通常动态分配且更换频繁，属于住宅类 IP": "Whether this IP belongs to a mobile carrier (4G/5G).", "该 IP 是否属于数据中心(IDC)、云服务商或主机托管服务。数据中心 IP 常被用于服务器部署，部分网站可能限制此类 IP 访问": "Whether this IP belongs to a datacenter, cloud host, or hosting service.", "该 IP 是否属于已知的 VPN (虚拟私人网络)服务提供商。VPN 用于加密网络流量和隐藏真实位置，部分网站会限制 VPN 访问": "Whether this IP belongs to a known VPN provider.", "该 IP 是否被识别为公开的代理服务器(如 HTTP/SOCKS 代理)。代理服务器可能被用于隐藏真实 IP，部分服务会限制代理访问": "Whether this IP is identified as a public proxy server (HTTP/SOCKS).", "该 IP 是否属于 Tor (洋葱路由)匿名网络的出口节点。Tor 提供高度匿名性，但也常被用于非法活动，因此大多数网站会限制或禁止 Tor 访问": "Whether this IP is a Tor exit node.", "该 IP 是否为虚假 IP (Bogon IP)，即保留地址、私有地址或未分配的地址段。此类 IP 不应出现在公网上，可能表示异常流量或蜜罐": "Whether this IP is a Bogon IP (private, reserved, or unallocated).", "该 IP 是否来自卫星互联网服务(如 Starlink、OneWeb 等)。卫星网络通常用于偏远地区或移动场景的互联网接入，延迟较高": "Whether this IP is from a satellite internet provider (Starlink, OneWeb).", "该 IP 是否被识别为网络爬虫(搜索引擎蜘蛛、数据采集机器人等)。爬虫可能对网站造成额外负担，部分网站会限制或特殊处理爬虫流量": "Whether this IP is identified as a web crawler or search bot.", "IP 的网络类型:【住宅】家庭宽带、【机房】数据中心或云服务器、【商用】企业专线。左侧为运营商分类，右侧为 ASN (自治系统)分类": "Network type: [Residential] Home broadband, [Datacenter] Cloud/Servers, [Business] Enterprise line.", "IP 地址的物理位置，通过 IP 地址段分配数据库推算得出，包括国家/地区、州省和城市信息": "Physical location estimated via IP allocation databases, including country, region, and city.", "该 IP 地址所在地区使用的标准时区，格式为洲/城市，如 Asia/Shanghai": "Standard timezone used by this IP region (e.g. Asia/Shanghai).", "今天的请求配额:": "Today's request quota: ", "请求使用进度:": "Request usage: ", "当前版本未匹配到日志条目:": "Current version did not match log entry: ", "当前版本定位成功:": "Current version located successfully: ", "拉取失败，已尝试原始链接和全部": "Fetch failed; tried original link and all ", "个备用镜像": " mirrors", "字符，字典": " chars, dictionary ", "字符": " chars", "高手模式": "Expert Mode", "新手模式": "Simple Mode", "简易模式": "Simple Mode", "基本信息": "Basic Info", "节点设置": "Node Settings", "网络测速": "Network Speed Test", "节点测速结果": "Node Speed Test Results", "测速": "Speed Test", "开始测试": "Start Test", "停止测试": "Stop Test", "清空测试结果": "Clear Test Results", "测试所有节点": "Test All Nodes", "测速中": "Testing...", "测速完成": "Test Completed", "已测速": "Tested", "未测速": "Untested", "快速测试": "Quick Test", "网络诊断": "Network Diagnostics", "连接测试": "Connectivity Test", "可用性": "Availability", "延迟值": "Latency", "丢包": "Packet Loss", "下载": "Download", "上传": "Upload", "优选参数": "Optimization Parameters", "优选节点列表": "Optimized Node List", "反代节点列表": "Reverse Proxy Node List", "添加自定义节点": "Add Custom Node", "清空自定义节点": "Clear Custom Nodes", "导入优选节点": "Import Optimized Nodes", "导出配置": "Export Config", "重置为默认值": "Reset to Default", "重置所有配置": "Reset All Configurations", "恢复出厂设置": "Factory Reset", "备份配置": "Backup Config", "还原配置": "Restore Config", "配置项": "Configuration Item", "参数说明": "Parameter Description", "当前值": "Current Value", "默认值": "Default Value", "修改为": "Change to", "立即生效": "Takes effect immediately", "需重启后生效": "Requires restart to take effect", "配置已生效": "Configuration applied", "请谨慎操作": "Proceed with caution", "不可逆操作": "Irreversible operation", "是否确认继续？": "Are you sure you want to continue?", "是否确认删除？": "Are you sure you want to delete?", "是否确认重置？": "Are you sure you want to reset?", "是否确认清空？": "Are you sure you want to clear?", "输入有误": "Invalid input", "不能为空": "Cannot be empty", "格式错误": "Invalid format", "范围错误": "Out of range", "已超出最大限制": "Exceeded maximum limit", "已低于最小限制": "Below minimum limit", "仅用于测试环境": "For testing environments only", "不推荐在生产环境开启": "Not recommended in production", "请求总数": "Total Requests", "已用请求数": "Used Requests", "剩余请求数": "Remaining Requests", "配额上限": "Quota Limit", "使用率": "Usage Rate", "重置倒计时": "Reset Countdown", "账户邮箱": "Account Email", "全局API密钥": "Global API Key", "账户ID": "Account ID", "API令牌": "API Token", "用量API接口": "Usage API Endpoint", "验证Cloudflare凭据": "Verify Cloudflare Credentials", "凭据有效": "Credentials Valid", "凭据无效": "Credentials Invalid", "未配置Cloudflare账户": "Cloudflare account not configured", "Bot Token 令牌": "Bot Token", "Chat ID 对话ID": "Chat ID", "发送测试消息": "Send Test Message", "测试消息发送成功": "Test message sent successfully", "测试消息发送失败": "Failed to send test message", "通知事件": "Notification Events", "登录通知": "Login Notification", "配置修改通知": "Config Change Notification", "配额警告通知": "Quota Warning Notification", "节点访问通知": "Node Access Notification", "订阅转换": "Subscription Conversion", "订阅地址": "Subscription URL", "转换后端": "Converter Backend", "远程配置规则": "Remote Config Rules", "包含Emoji表情": "Include Emoji", "排除节点": "Exclude Nodes", "包含节点": "Include Nodes", "节点重命名规则": "Node Rename Rules", "UDP转发": "UDP Forwarding", "节点排序方式": "Node Sorting Order", "更新间隔": "Update Interval", "小时更新一次": " hours per update", "SOCKS5 代理": "SOCKS5 Proxy", "HTTP 代理": "HTTP Proxy", "HTTPS 代理": "HTTPS Proxy", "TURN 代理": "TURN Proxy", "SSTP 代理": "SSTP Proxy", "链式代理配置": "Chained Proxy Configuration", "目标代理": "Target Proxy", "前置代理": "Front Proxy", "跳板代理": "Hop Proxy", "直接连接": "Direct Connection", "自动选择": "Auto Select", "手动指定": "Manually Specify", "测试连接": "Test Connection", "连接成功": "Connection Successful", "连接超时": "Connection Timed Out", "连接被拒绝": "Connection Refused", "亚洲": "Asia", "欧洲": "Europe", "北美洲": "North America", "南美洲": "South America", "大洋洲": "Oceania", "非洲": "Africa", "香港": "Hong Kong", "台湾": "Taiwan", "日本": "Japan", "韩国": "South Korea", "新加坡": "Singapore", "美国": "United States", "英国": "United Kingdom", "德国": "Germany", "法国": "France", "加拿大": "Canada", "澳大利亚": "Australia", "俄罗斯": "Russia", "印度": "India", "客户端IP": "Client IP", "访问时间": "Access Time", "访问域名": "Accessed Domain", "访问路径": "Accessed Path", "请求方法": "Request Method", "用户代理": "User Agent", "状态码": "Status Code", "流量大小": "Traffic Size", "筛选日志": "Filter Logs", "按IP筛选": "Filter by IP", "按时间筛选": "Filter by Time", "按类型筛选": "Filter by Type", "导出日志": "Export Logs", "日志已清空": "Logs cleared", "暂无日志记录": "No logs recorded", "自动刷新": "Auto Refresh", "每5秒刷新": "Refresh every 5s", "每10秒刷新": "Refresh every 10s", "每30秒刷新": "Refresh every 30s", "暂停刷新": "Pause Refresh", "请填写": "Please enter ", "点击复制": "Click to copy", "点击查看": "Click to view", "点击展开": "Click to expand", "点击收起": "Click to collapse", "更多选项": "More options", "高级选项": "Advanced options", "展开全部": "Expand all", "收起全部": "Collapse all", "注意:": "Note: ", "警告:": "Warning: ", "提示:": "Tip: ", "说明:": "Description: ", "例如:": "e.g., ", "推荐:": "Recommended: ", "可选": "Optional", "必填": "Required", "启用中": "Enabled", "已禁用": "Disabled", "运行中": "Running", "已停止": "Stopped", "良好": "Good", "极佳": "Excellent", "较差": "Poor", "不可用": "Unavailable", "毫秒": "ms", "字节": "Bytes", "兆字节": "MB", "吉字节": "GB", "秒前": "s ago", "分钟前": "m ago", "小时前": "h ago", "天前": "d ago", "刚刚": "Just now", "弹窗": "popup", "配置": "configuration", "订阅": "Subscription", "优选": "Optimized", "加密": "Encryption", "选择目标": "select target", "节点": "Node", "链式": "chained", "功能": "feature", "解析": "resolve", "请求": "Request", "查看": "View", "通知": "Notification", "日志": "Logs", "内核": "kernel", "协商": "negotiate", "订阅转换后端": "subconverter backend", "方式": "method", "缺少占位符": "missing placeholder", "传输": "transport", "自动获取": "auto-detect", "落地": "Egress", "站点": "website", "服务器": "server", "客户端": "client", "设置": "Settings", "说明": "Description", "模块": "Module", "输入": "Enter", "使用": "Use", "地址": "Address", "信息": "Info", "链接": "Link", "模式": "Mode", "随机": "Random", "列表中": "in list", "可用的": "available", "专用的": "dedicated", "将非": "Route non-", "的流量也走": " traffic through ", "或者": "or", "支持": "Support", "列表": "List", "帮助": "Help", "参数": "Parameters", "生成": "Generate", "测试": "Test", "工具": "Tools", "服务": "Service", "数据": "Data", "高级": "Advanced", "控制台": "Console", "环境": "Environment", "变量": "Variable", "证书": "Certificate", "指纹": "Fingerprint", "规则": "Rules", "配额": "Quota", "用量": "Usage", "统计": "Statistics", "概览": "Overview", "详情": "Details", "隐藏": "Hide", "显示": "Show", "切换": "Switch", "导出": "Export", "导入": "Import", "粘贴": "Paste", "历史": "History", "记录": "Records", "注意": "Notice", "建议": "Recommended", "必须": "Required", "全部": "All", "当前": "Current", "最新": "Latest", "正在": "In progress: ", "已完成": "Completed", "未完成": "Incomplete", "正常": "Normal", "异常": "Abnormal", "有效": "Valid", "无效": "Invalid", "超时": "Timeout", "跳过": "Skip", "保留": "Keep", "提交": "Submit", "返回": "Back", "下一步": "Next", "上一步": "Previous", "完成": "Done", "继续": "Continue", "暂停": "Pause", "停止": "Stop", "开始": "Start", "重新": "Re-", "验证": "Verify", "检测": "Check", "带宽": "Bandwidth", "速率": "Speed", "日期": "Date", "今天": "Today", "昨天": "Yesterday", "分钟": "minutes", "秒钟": "seconds", "中国": "China", "移动": "Mobile", "联通": "Unicom", "电信": "Telecom", "官方": "Official", "跳板": "Bounce Proxy", "出口": "Outbound", "入口": "Inbound", "主机": "Host", "接口": "API", "用户": "User", "令牌": "Token", "邮箱": "Email", "分片": "Fragment", "伪装": "Disguise", "解密": "Decryption", "压缩": "Compression", "缓存": "Cache", "连接": "Connection", "断开": "Disconnected", "重连": "Reconnect", "并发": "Concurrent", "队列": "Queue", "缓冲区": "Buffer", "响应": "Response", "警报": "Alert", "版本": "Version", "更新": "Update", "升级": "Upgrade", "文档": "Docs", "教程": "Tutorial", "社区": "Community", "反馈": "Feedback", "赞助": "Sponsor", "项目": "Project", "授权": "License", "作者": "Author", "根据Subscription时的网络自动下发对应网络的Official Optimized": "Auto-assigned official optimized nodes based on your network at subscription time", "根据订阅时的网络自动下发对应网络的官方优选": "Auto-assigned official optimized nodes based on your network at subscription time", "需要汇聚的Subscription URL": "Subscription URL to aggregate", "需要汇聚的订阅 URL": "Subscription URL to aggregate", "未生效，或clientVersion、DNS configuration存在问题": "is inactive, or client version / DNS configuration has issues", "未生效，或客户端版本、DNS配置存在问题": "is inactive, or client version / DNS configuration has issues", "仅可通过 'PATH'EnvironmentVariable 进行修改": "can only be modified via 'PATH' environment variable", "仅可通过 'PATH'环境变量 进行修改": "can only be modified via 'PATH' environment variable", "69云机场": "69yun", "抄作业，直接Use大佬Optimized好的结果": "Use community-tested optimized results directly", "抄作业，直接使用大佬优选好的结果": "Use community-tested optimized results directly", "小火箭": "Shadowrocket", "dedicatedTLS Fragmentationfeature": "dedicated TLS fragmentation feature", "专属TLS分片功能": "dedicated TLS fragmentation feature", "UseNode的SNI Domainresolve EchConfig": "Resolve EchConfig using node SNI domain", "使用节点的伪装域名解析 EchConfig": "Resolve EchConfig using node SNI domain", "您已Enable ECH，但CurrentSelect的Browser Fingerprint": "You enabled ECH, but the currently selected browser fingerprint", "您已启用 ECH，但当前选择的浏览器指纹": "You enabled ECH, but the currently selected browser fingerprint", "OK是否Clear Cloudflare Notificationconfiguration？": "Confirm clearing Cloudflare notification configuration?", "确认是否清除 Cloudflare 通知配置？": "Confirm clearing Cloudflare notification configuration?", "是否在UpdateSubscription时覆盖了原有的 DNS configuration": "Whether existing DNS configuration was overwritten during subscription update", "是否在更新订阅时覆盖了原有的 DNS 配置": "Whether existing DNS configuration was overwritten during subscription update", "Select一款Tools，点击「前往 GitHub」即可在新窗口View与Download": "Select a tool and click 'Go to GitHub' to view and download in a new window", "选择一款工具，点击「前往 GitHub」即可在新窗口查看与下载": "Select a tool and click 'Go to GitHub' to view and download in a new window", "OK是否Clear Telegram Notificationsconfiguration？": "Confirm clearing Telegram notification configuration?", "确认是否清除 Telegram Bot 通知配置？": "Confirm clearing Telegram notification configuration?", "通过阻断NodeDomain的访问来干扰ProxyConnection": "blocks node domain access to interfere with proxy connections", "通过阻断节点域名的访问来干扰代理连接": "blocks node domain access to interfere with proxy connections", "DownloadLatestPages.zipSource Upload部署": "Download latest Pages.zip source to upload and deploy", "下载最新Pages.zip源码 上传部署": "Download latest Pages.zip source to upload and deploy", "Settings不当可能导致Node与您的client或网络Environment不兼容": "Improper settings may cause incompatibility with your client or network environment", "设置不当可能导致节点与您的客户端或网络环境不兼容": "Improper settings may cause incompatibility with your client or network environment", "Update到2.1.20260811144522Version之后就稳了！": "is stable after updating to version 2.1.20260811144522!", "更新到2.1.20260811144522版本之后就稳了！": "is stable after updating to version 2.1.20260811144522!", "没有被封的国外website": "unblocked international websites", "没有被封的国外网站": "unblocked international websites", "所Use的EgressIP": " egress IP used", "所使用的落地IP": " egress IP used", "Support汇聚Subscription": "Supports subscription aggregation", "支持汇聚订阅": "Supports subscription aggregation", "这意味着Generate的Subscriptionconfiguration将": "This means generated subscription configuration will", "这意味着生成的订阅配置将": "This means generated subscription configuration will", "UseDefault内置的PROXYIP": "Use default built-in PROXYIP", "使用默认内置的PROXYIP": "Use default built-in PROXYIP", "通过浏览器实时进行Online Optimized，兼容性高，有浏览器就能进行": "Real-time browser-based latency optimization, works in any browser", "通过浏览器实时进行在线优选，兼容性高，有浏览器就能进行": "Real-time browser-based latency optimization, works in any browser", "Use的Optimized IP/Domain的 Port Required是": "The port of the optimized IP/domain must be", "使用的优选IP/域名的 端口必须是": "The port of the optimized IP/domain must be", "Downloadclient在本地设备上运行，灵活多变，feature性更多": "Download client to run locally for flexibility and more features", "下载客户端在本地设备上运行，灵活多变，功能性更多": "Download client to run locally for flexibility and more features", "为什么需要Reverse Proxy Mode？PROXYIP又是什么？": "Why is Reverse Proxy Mode needed? What is PROXYIP?", "为什么需要反代模式？PROXYIP又是什么？": "Why is Reverse Proxy Mode needed? What is PROXYIP?", "从 ProxyIP in listSelectavailableProxy": "Select available proxy from ProxyIP list", "从 ProxyIP 列表中选择可用的代理": "Select available proxy from ProxyIP list", "可用Request数Statistics": "Available Request Statistics", "可用请求数统计": "Available Request Statistics", "墙外website": "international websites", "墙外网站": "international websites", "CopyLatestWorker.jsSource 到剪贴板": "Copy latest Worker.js source to clipboard", "复制最新Worker.js源码 到剪贴板": "Copy latest Worker.js source to clipboard", "Use前请Confirm以下两点：": "Please confirm the following two points before use:", "使用前请确认以下两点：": "Please confirm the following two points before use:", "Currentconfiguration的NodeSNI Domain：": "Current node SNI domain: ", "当前配置的节点伪装域名：": "Current node SNI domain: ", "ViewSubscription鉴权 TOKEN Description": "View subscription authentication TOKEN guide", "查看订阅鉴权 TOKEN 说明": "View subscription authentication TOKEN guide", "其值将不再随 ADMIN/KEY 的改动而发生变化。": "value will no longer change when ADMIN or KEY changes.", "实际EgressIP 由 Optimized Domain/IP 决定": "Actual egress IP is determined by optimized domain/IP", "实际落地IP 由 优选域名/IP 决定": "Actual egress IP is determined by 优选域名/IP", "Support多AccountStatistics": "Supports multi-account statistics", "支持多账号统计": "Supports multi-account statistics", "ViewCustom Optimized 填写Description": "View custom optimized entry instructions", "查看自定义优选 填写说明": "View custom optimized entry instructions", "外部Bounce Proxy，帮 Worker Continue访问": "External bounce proxy helps Worker continue requests", "外部跳板代理，帮 Worker 继续访问": "External bounce proxy helps Worker continue requests", "不附加Rules和策略组": "without rules or policy groups", "不附加规则和策略组": "without rules or policy groups", "CurrentSubscriptionconfiguration中已": "Current subscription config has ", "当前订阅配置中已": "Current subscription config has ", "Optimized Domain/IP Port不写Default": "leave optimized domain/IP port blank for default", "优选域名/IP 端口不写默认": "leave optimized domain/IP port blank for default", "Use firefox Fingerprint并Enable ECH": "Use Firefox fingerprint and enable ECH", "使用 firefox 指纹并开启 ECH": "Use Firefox fingerprint and enable ECH", "从SOCKS5in listSelectavailableProxy": "Select available proxy from SOCKS5 list", "从SOCKS5列表中选择可用的代理": "Select available proxy from SOCKS5 list", "Path Template中Required存在Path占位符": "Path template must contain path placeholder", "路径模板中必须存在路径占位符": "Path template must contain path placeholder", "Use chrome Fingerprint并Enable ECH": "Use Chrome fingerprint and enable ECH", "使用 chrome 指纹并开启 ECH": "Use Chrome fingerprint and enable ECH", "Celestia Module化区块链": "Celestia Modular Blockchain", "Celestia 模块化区块链": "Celestia Modular Blockchain", "transport与EncryptionDescription": "Transport and Encryption Guide", "传输与加密说明": "Transport and Encryption Guide", "不要覆盖Subscription中自带的 DNS Settings": "Do not overwrite built-in DNS settings in subscription", "不要覆盖订阅中自带的 DNS 设置": "Do not overwrite built-in DNS settings in subscription", "从HTTPSin listSelectavailableProxy": "Select available proxy from HTTPS list", "从HTTPS列表中选择可用的代理": "Select available proxy from HTTPS list", "详细configurationInfo": "Detailed Configuration Info", "详细配置信息": "Detailed Configuration Info", "Close TLStransport层Encryption": "Disable TLS Transport Encryption", "关闭 TLS传输层加密": "Disable TLS Transport Encryption", "从HTTPin listSelectavailableProxy": "Select available proxy from HTTP list", "从HTTP列表中选择可用的代理": "Select available proxy from HTTP list", "将原本会明文暴露的DomainInfo一起Encryption": "Encrypts domain information otherwise exposed in plaintext", "将原本会明文暴露的域名信息一起加密": "Encrypts domain information otherwise exposed in plaintext", "Please select 一种Optimizedmethod": "Please select an optimization method", "请选择 一种优选方式": "Please select an optimization method", "误伤大量NormalUse ECH 的网站和Service": "Mistakenly blocks many normal sites and services using ECH", "误伤大量正常使用 ECH 的网站和服务": "Mistakenly blocks many normal sites and services using ECH", "Generate专属 Snippet.js Source": "Generate Custom Snippet.js Source", "生成专属 Snippet.js 源码": "Generate Custom Snippet.js Source", "缺点：需Downloadclient，在本地设备上运行": "Disadvantage: requires downloading client to run on local device", "缺点：需下载客户端，在本地设备上运行": "Disadvantage: requires downloading client to run on local device", "CustomSubconverter Config文件URL": "Custom Subconverter Config File URL", "自定义订阅转换配置文件URL": "Custom Subconverter Config File URL", "将 SNI（也就是NodeDomain）Encryption": "Encrypts SNI (node domain name)", "将 SNI（也就是节点域名）加密": "Encrypts SNI (node domain name)", "访问非 Cloudflare CDN website": "Accessing non-Cloudflare CDN sites", "访问非 Cloudflare CDN 网站": "Accessing non-Cloudflare CDN sites", "实际通信内容已经被 TLS Encryption": "Actual communication is already encrypted by TLS", "实际通信内容已经被 TLS 加密": "Actual communication is already encrypted by TLS", "Godot 开源游戏引擎": "Godot Open Source Game Engine", "未configuration为NodeSNI Domain": "Not configured as node SNI domain", "未配置为节点伪装域名": "Not configured as node SNI domain", "在Node Name中匹配并Show Emoji 旗帜图标": "Match and display Emoji flag icons in node names", "在节点名称中匹配并显示 Emoji 旗帜图标": "Match and display Emoji flag icons in node names", "访问 Cloudflare CDN website": "Accessing Cloudflare CDN sites", "访问 Cloudflare CDN 网站": "Accessing Cloudflare CDN sites", "如果Node可以NormalConnectionUse": "If the node connects and functions normally", "如果节点可以正常连接使用": "If the node connects and functions normally", "APIBack结果将Show在这里，每行一个Address": "API returned results will be displayed here, one address per line", "API返回结果将显示在这里，每行一个地址": "API returned results will be displayed here, one address per line", "系统将会根据算法动态Generate新的 UUID": "System will dynamically generate new UUID based on algorithm", "系统将会根据算法动态生成新的 UUID": "System will dynamically generate new UUID based on algorithm", "展开Rules全文，输出完整 min 流RulesList": "Expand full rules to output minimal stream rule list", "展开规则全文，输出完整 min 流规则列表": "Expand full rules to output minimal stream rule list", "RandomDisguisePath(自慰feature)": "Random Disguise Path", "随机伪装路径(自慰功能)": "Random Disguise Path", "Kyocera 集团官网": "Kyocera Group Official", "仅在": "only in ", "但在 TLS 握手阶段，仍然会暴露一个关键Info：": "However, during TLS handshake, one key piece of info is exposed:", "但在 TLS 握手阶段，仍然会暴露一个关键信息：": "However, during TLS handshake, one key piece of info is exposed:", "Close TLS 前，请Confirm以下三点：": "Before disabling TLS, please confirm the following three points:", "关闭 TLS 前，请确认以下三点：": "Before disabling TLS, please confirm the following three points:", "真实被墙的Domain已被Hide，对外仅Show为": "real blocked domain is hidden, appearing externally as ", "真实被墙的域名已被隐藏，对外仅显示为": "real blocked domain is hidden, appearing externally as ", "SNI 就是Node的SNI Domain（HOST）": "SNI is the node SNI disguise domain (HOST)", "SNI 就是节点的伪装域名（HOST）": "SNI is the node SNI disguise domain (HOST)", "这就是为什么在以下场景中经常出现Abnormal情况：": "This is why anomalies frequently occur in these scenarios:", "这就是为什么在以下场景中经常出现异常情况：": "This is why anomalies frequently occur in these scenarios:", "批量Test真LinkLatency": "batch tests real connection latency", "批量测试真连接延迟": "batch tests real connection latency", "Cloudflare CDN 访问Settings": "Cloudflare CDN Access Settings", "Cloudflare CDN 访问设置": "Cloudflare CDN Access Settings", "SelectTarget Proxy (最多8个)": "Select Target Proxies (up to 8)", "选择目标代理 (最多8个)": "Select Target Proxies (up to 8)", "ECH 与Browser Fingerprint冲突": "ECH conflicts with browser fingerprint", "ECH 与浏览器指纹冲突": "ECH conflicts with browser fingerprint", "Project获取 UsageAPI Address": "project to obtain UsageAPI address", "项目获取 UsageAPI 地址": "project to obtain UsageAPI address", "策略组Auto SelectNode": "policy groups auto-select nodes", "策略组自动选择节点": "policy groups auto-select nodes", "Please select Statistics方案": "Please select a statistics method", "请选择 统计方案": "Please select a statistics method", "用于获取 EchConfig 的DNSService": "DNS service used to obtain EchConfig", "用于获取 EchConfig 的DNS服务": "DNS service used to obtain EchConfig", "Workers/Pages RequestUse情况": "Workers/Pages Request Usage Status", "Workers/Pages 请求使用情况": "Workers/Pages Request Usage Status", "你CurrentProject的已被墙的Domain": "Your current project's blocked domain", "你当前项目的已被墙的域名": "Your current project's blocked domain", "大英百科全书": "Encyclopaedia Britannica", "您Current访问管理面板Use的Domain是：": "Domain currently used to access admin dashboard: ", "您当前访问管理面板使用的域名是：": "Domain currently used to access admin dashboard: ", "Support多Account汇总，可通过部署": "Supports multi-account aggregation via deploying ", "支持多账号汇总，可通过部署": "Supports multi-account aggregation via deploying ", "Reverse Proxy资源来自 Github、": "Reverse proxy resources sourced from GitHub, ", "反代资源来自 Github、": "Reverse proxy resources sourced from GitHub, ", "您CurrentSelect的 ALPN 选项为「": "Your currently selected ALPN option is '", "您当前选择的 ALPN 选项为「": "Your currently selected ALPN option is '", "OptimizedPort 1~65535，可留空": "Optimized Port 1~65535, can be left blank", "优选端口 1~65535，可留空": "Optimized Port 1~65535, can be left blank", "及后续Version将陆续StopSupport": "and subsequent versions will discontinue support for ", "及后续版本将陆续停止支持": "and subsequent versions will discontinue support for ", "ECH 能持续多久，取决于 GFW 的取舍与策略": "How long ECH lasts depends on censorship policies", "前往 GitHub": "Go to GitHub", "自慰功能": "dummy feature", "集团官网": "Official Website", "应用层协议优先级": "application layer protocol priority", "留空": "leave empty", "可留空": "can be left empty", "必填项": "Required field", "选填项": "Optional field", "的": "", "为什么需要": "Why is it needed: ", "又是什么": "What is it: ", "是否已经生效": "whether it is active", "科技大学": "University of Science and Technology", "等开源": "and other open-source", "什么是": "What is ", "未生效": "inactive", "存在问题": "has issues", "需要汇聚": "needs aggregation", "您已": "You have ", "决定": "determines", "如何": "How to ", "是否": "whether", "例如": "e.g., ", "所有": "all", "访问": "access", "网络": "network", "展开": "expand", "全文": "full text", "方案": "solution", "因此": "therefore", "即可": "ready", "频道": "channel", "数量": "count", "案例": "case", "无法": "unable to", "修改": "modify", "优点": "advantages", "缺点": "disadvantages", "作为": "as", "本地": "local", "其他": "other", "了解": "learn more", "相关": "related", "国外": "international", "需要": "requires", "获取": "obtain", "重要": "important", "结果": "results", "或": "or", "为": "is", "是": "is", "后": "after", "已": "already", "在": "in", "该": "this", "器": "engine", "流": "stream", "你": "you", "但": "but", "值": "value", "与": "and", "和": "and", "从": "from", "到": "to", "由": "by", "将": "will", "使": "make", "对": "correct", "被": "is", "不": "not", "无": "no", "有": "has", "可": "can", "多": "multi-", "单": "single", "新": "new", "旧": "old", "大": "large", "小": "small", "高": "high", "低": "low", "快": "fast", "慢": "slow", "好": "good", "坏": "bad", "此": "this", "其": "its", "各": "each", "每": "every", "全": "all", "部": "part", "点": "point", "线": "line", "面": "surface", "体": "body", "项": "item", "条": "bar", "个": "items", "次": "times", "种": "types", "类": "category", "级": "level", "层": "layer", "段": "segment", "区": "region", "界": "world", "端": "endpoint", "侧": "side", "前": "before", "中": "middle", "上": "up", "下": "down", "左": "left", "右": "right", "内": "internal", "外": "external", "源": "source", "目": "target", "标": "tag", "记": "record", "号": "number", "码": "code", "名": "name", "称": "title", "字": "character", "词": "word", "句": "sentence", "篇": "article", "章": "chapter", "节": "section", "页": "page", "表": "table", "图": "image", "文": "text", "件": "file", "夹": "folder", "库": "library", "包": "package", "块": "block", "组": "group", "队": "queue", "列": "column", "行": "run", "格": "grid", "框": "box", "栏": "bar", "卡": "card", "板": "panel", "窗": "window", "台": "platform", "网": "net", "络": "work", "站": "site", "通": "pass", "达": "reach", "信": "message", "息": "info", "告": "notice", "示": "display", "警": "alert", "报": "report", "误": "error", "错": "wrong", "正": "correct", "确": "confirm", "定": "set", "变": "change", "更": "update", "改": "edit", "换": "switch", "替": "replace", "设": "set", "置": "place", "配": "config", "备": "prepare", "份": "copy", "存": "save", "储": "store", "载": "load", "传": "transfer", "输": "input", "发": "send", "送": "send", "收": "receive", "取": "get", "拿": "fetch", "放": "put", "给": "give", "用": "use", "操": "operate", "作": "do", "动": "action", "开": "open", "关": "close", "启": "start", "停": "stop", "止": "halt", "结": "end", "束": "finish", "终": "terminate", "始": "begin", "初": "init", "创": "create", "建": "build", "造": "make", "成": "finish", "立": "establish", "破": "break", "毁": "destroy", "删": "delete", "除": "remove", "加": "add", "增": "increase", "减": "decrease", "乘": "multiply", "降": "drop", "升": "rise", "查": "search", "看": "view", "见": "see", "听": "listen", "读": "read", "写": "write", "录": "record", "测": "test", "试": "try", "验": "verify", "证": "auth", "评": "rate", "估": "estimate", "算": "calc", "计": "count", "量": "volume", "数": "data", "据": "data", "析": "analyze", "解": "resolve", "释": "explain", "明": "clear", "白": "white", "黑": "black", "灰": "gray", "红": "red", "绿": "green", "蓝": "blue", "黄": "yellow", "紫": "purple", "橙": "orange", "金": "gold", "银": "silver", "铜": "bronze", "铁": "iron", "钢": "steel", "由于这种阻断大多是自动化策略": "", "带来较高封锁成本和副作用": "", "至少在目前阶段仍然非常": "", "无法看到你访问具体内容": "", "强制锁定为您指定值": "", "如果出现以下情况": "", "核心安全策略调整": "", "只负责把你带到": "", "简单且直观方法": "simple and intuitive method", "中手动填写一个": "", "会带来什么问题": "", "发现目标也在": "", "消耗少速度快": "", "如何判断结果": "", "无法获取真实": "", "没有被封国外": "", "可以通过一个": "", "最终流量会以": "", "其原因并不是": "", "就近机房处理": "", "一项新特性": "", "是由您梯子": "", "核心作用是": "", "最坏情况下": "", "我想简单点": "", "我准备好了": "", "阻断了通过": "", "阻断时无法": "", "一行写一条": "", "会不会被封": "", "外部观察到": "", "一旦手动为": "", "这从源头上": "", "后即可生效": "", "将无法建立": "", "我知道风险": "", "表现通常为": "", "又可能恢复": "", "汇聚机场": "", "每行一个": "", "仍然无法": "", "流动质押": "", "混淆重组": "", "情况总计": "", "可能无法": "", "追加结果": "", "才能适配": "", "资源来自": "", "我是小白": "", "设定符合": "", "预设模板": "", "精准封锁": "", "欢迎开源": "", "非常简单": "", "是否完全": "", "我知道了": "", "一行一个": "", "但这样会": "", "直接阻断": "", "汇聚现成": "", "直接赋值": "", "影响范围": "", "容易误判": "", "灵活多变": "", "如何修改": "", "等待加载": "", "动态关联": "", "漏网之鱼": "", "小白勿用": "", "无需安装": "", "花里胡笑": "", "手动固定": "", "反复循环": "", "即开即用": "", "也就是说": "", "输出完整": "", "图形界面": "", "网页界面": "", "结果将": "", "理论上": "", "命令行": "", "中查找": "", "将导致": "", "部署在": "", "当我们": "", "场景二": "", "请稍候": "", "真失效": "", "只需要": "", "过一段": "", "自适应": "", "你连到": "", "请前往": "", "并尝试": "", "如果你": "", "并应用": "", "后可加": "", "访问非": "", "加载中": "", "内不再": "", "在这里": "", "将统一": "", "是由您": "", "场景一": "", "愛料理": "", "事项": "", "一个": "", "实际": "", "只需": "", "消息": "", "普通": "", "无需": "", "直接": "", "内置": "", "一种": "", "生效": "", "打开": "", "所需": "", "写成": "", "背景": "", "清零": "", "设定": "", "步骤": "", "投稿": "", "逗号": "", "备注": "", "批量": "", "今日": "", "用来": "", "每行": "", "可将": "", "这是": "", "否则": "", "运行": "", "手段": "", "大佬": "", "等待": "", "易受": "", "不是": "", "后端": "", "墙外": "", "指定": "", "丰富": "", "明文": "", "推荐": "", "我已": "", "瞬间": "", "阻断": "", "网页": "", "北京": "", "总结": "", "汇聚": "", "工作": "", "配合": "", "作用": "", "追加": "", "格式": "", "一旦": "", "每日": "", "面板": "", "准备": "", "外部": "", "根据": "", "如果": "", "文件": "", "进行": "", "不会": "", "而是": "", "则": "", "等": "", "而": "", "帮": "", "如": "", "来": "", "请": "", "日": "", "了": "", "均": "", "真": "", "非": "", "时": "", "具体内容": "specific content", "简单": "simple", "直观": "intuitive", "方法": "method", "带较高封锁成本和副作用": "carries higher blocking costs and side effects", "成本": "cost", "副作用": "side effects", "没有被封": "unblocked", "未被封": "unblocked", "强制锁定为您设置的值": "forcefully locked to your configured value", "强制锁定": "forcefully locked", "节点失效": "node expires / fails", "失效": "fails / expires", "没": "not", "具": "specific", "容": "content", "锁": "lock", "带": "carries", "本": "cost", "副": "side", "简": "simple", "直": "direct", "观": "view", "法": "method", "封": "block", "较": "more", "您": "your", "且": "and"};
		const sortedKeys = Object.keys(dict).sort((a, b) => b.length - a.length);

		// Translation is done entirely client-side by the i18nScript below.
		// Server-side string replacement was removed because it's impossible to
		// reliably protect <script> blocks from dictionary substitution — Chinese
		// property names like currentConfig.反代 would become currentConfig.Reverse Proxy,
		// causing SyntaxError: Unexpected identifier 'Proxy'.
...
(function() {
  ...
  function translateText(text) {
    ...
    for (let i = 0; i < sortedKeys.length; i++) {
      ...
      if (text.includes(k)) text = text.replaceAll(k, dict[k]);
    }
    return text;
  }

  // Intercept window.showToast if available
  const origShowToast = window.showToast;
  window.showToast = function(msg, type, ...args) {
    if (typeof msg === 'string') msg = translateText(msg);
    if (origShowToast) return origShowToast.call(this, msg, type, ...args);
  };
...
export default {
	async fetch(request, env, ctx) {
		...
		const 加密秘钥 = env.KEY || 'DEFAULT_KEY_DO_NOT_USE_SET_KEY_VARIABLE_INSTEAD';
		...
		if (访问路径 === 'version') {// 版本信息接口
			...
			if (env.KV && typeof env.KV.get === 'function') {
				...
				if (区分大小写访问路径 === 加密秘钥 && 加密秘钥 !== 'DEFAULT_KEY_DO_NOT_USE_SET_KEY_VARIABLE_INSTEAD') {//快速订阅
					...
					if (访问路径 === 'admin/init') {// 重置配置为默认值
						...
						if (访问路径 === 'admin/config.json') { // 保存config.json配置
							...
							try {
								...
								return new Response(JSON.stringify({ success: true, message: 'Custom IP saved successfully' }), { status: 200, headers: { 'Content-Type': 'application/json;charset=utf-8' } });
							} catch (error) {
					...
					return 获取前端页面('/admin' + url.search);
...
async function 生成随机IP(request, count = 16, 指定端口 = -1) {
	...
	const cfname = 运营商名称映射[运营商文件标识] || 'CF-Optimized-';
...
async function 获取优选订阅生成器数据(优选订阅生成器HOST) {
	...
	try {
		...
		优选IP.push(`127.0.0.1:1234#${优选订阅生成器HOST}-SubGenerator-Format-Error:${error.message}`);
	...
	try {
		...
		if (!response.ok) {
			优选IP.push(`127.0.0.1:1234#${优选订阅生成器HOST}-SubGenerator-Error:${response.statusText}`);
			return [优选IP, 其他节点LINK];
		}
		...
		优选IP.push(`127.0.0.1:1234#${优选订阅生成器HOST}-SubGenerator-Error:${error.message}`);
	}
